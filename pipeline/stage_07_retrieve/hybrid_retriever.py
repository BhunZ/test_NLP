...
# Make sibling stage folders importable whether this file is run directly
# or imported via the pipeline package.
_PIPELINE_ROOT = Path(__file__).resolve().parent.parent
for _sub in ("stage_05_index", "stage_07_retrieve"):
    _p = str(_PIPELINE_ROOT / _sub)
...
from bm25_store import build_or_load_bm25                   # stage_05_index/
from reranker import build_reranker, rerank_documents       # stage_07 sibling (was re_ranker.py)
from vectorstore_builder import build_vectorstore           # stage_05_index/
