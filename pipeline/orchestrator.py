...
# Make every stage subfolder importable so the lazy `from x import y` calls
# below resolve regardless of how this orchestrator is invoked.
_PIPELINE_DIR = Path(__file__).resolve().parent
for _sub in (
    "stage_03_chunk", "stage_04_enrich", "stage_05_index",
    "stage_06_query_rewrite", "stage_07_retrieve",
...
# pipeline/orchestrator.py → repo root is parents[1]
...
def main() -> None:
    ...
    from hybrid_retriever import build_hybrid_retriever   # was hybrid_improved.py
    ...
    if not args.no_reranker:
        ...
        from reranker import build_reranker, rerank_documents   # was re_ranker.py
